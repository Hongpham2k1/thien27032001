...
public class ReplyCodeConstants {
	...
	public static final String READY_FOR_NEW_USER_MSG="Welcome to TEAM 3 FTP service";
	public static final String LOGGED_IN_FAILED_MSG="Username/Password invalid";
}
